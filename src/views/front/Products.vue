      ...
      <div class="row m-0 px-5 justify-content-center">
        <div class="col-md-3 col-7 fixed-md-top" style="margin-top: 70px;">
          <div class="list-group">
            ...
            <a href="#" class="list-group-item list-group-item-action"
              :class="{active:category==='碗盤'}" @click.prevent="targetcategory('碗盤')">碗盤</a>
            <a href="#" class="list-group-item list-group-item-action"
              :class="{active:category==='杯子'}" @click.prevent="targetcategory('杯子')">杯子</a>
            <a href="#" class="list-group-item list-group-item-action"
              :class="{active:category==='餐具'}" @click.prevent="targetcategory('餐具')">餐具</a>
          </div>
...
<style lang="scss" scoped>
  .bg{
      background-image: url('https://images.unsplash.com/photo-1503197553955-b4eafae3e08e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=995&q=80');
      height: 500px;
  };
  .bg-cover{
